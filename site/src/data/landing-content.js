  ...
  en: {
    ...
    examples: {
      ...
      items: [
        ...
        {
          label: 'Concise communication',
          correction: 'This is too long. Just tell me what changed and what passed.',
          rule: 'Lead with the result and include only the evidence needed to trust it.',
        },
      ],
    },
    install: {
  ...
  ko: {
    ...
    examples: {
      ...
      items: [
        {
          label: '범위 누수',
          correction: 'crop 편집만 고치랬는데 전체 레이아웃을 건드렸어.',
  ...
  ja: {
    ...
    examples: {
      ...
      items: [
        ...
        {
          label: '簡潔な応答',
          correction: '長すぎます。変更点と検証結果だけ教えて。',
          rule: '結果を先に伝え、信頼に必要な根拠だけを添える。',
        },
      ],
    },
    install: {
  ...
  zh: {
    ...
    examples: {
      ...
      items: [
        ...
        {
          label: '简洁回复',
          correction: '太长了。只告诉我改了什么、验证了什么。',
          rule: '先说明结果，再补充建立信任所需的证据。',
        },
      ],
    },
    install: {
    ...
    examples: {
      ...
      items: [
        ...
        },
        {
          ...
          correction: 'Esto es demasiado largo. Dime solo que cambio y que paso.',
          rule: 'Empieza por el resultado y luego incluye solo la evidencia necesaria.',
        },
      ],
    },
    install: {
